...
const Research = () => {
  const researchAreas = [
    ...
    {
      title: "Game AI & Search Algorithms",
      icon: <Zap className="w-8 h-8 text-orange-600" />,
      description: "Developed intelligent game agents using classical AI search algorithms and modern reinforcement learning techniques. Focused on multi-agent systems, adversarial search, and optimal decision-making in dynamic environments.",
      publications: [
        "Pacman AI Agent Implementation – University Research Project 2024",
        "Multi-Agent Search Strategies in Game Environments – Course Research 2024",
        "Comparative Analysis of Search Algorithms in AI Games – Academic Study 2024"
      ]
    }
  ];
